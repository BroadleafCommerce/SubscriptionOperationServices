...
class CustomerSubscriptionOperationEndpointIT {
    ...
    private Map<String, Object> populateAuthDetails(@Nullable String customerId,
            @Nullable String accountId,
            @Nullable String username,
            @Nullable String fullName,
            @Nullable String parentAccounts) {
        Map<String, Object> authDetails = new HashMap<>();
        authDetails.put("customer_id", customerId);
        authDetails.put("acct_id", accountId);
        authDetails.put("user_name", username);
        authDetails.put("full_name", fullName);
        authDetails.put("parent_accts", parentAccounts);
